...
impl Sandbox for MyButton {
  ...
  fn update(&mut self, message: Message) {
      ...
      Message::NextButton => nextfn(),
        ...
        Message::ButtonPressed44 => pushfn(String::from("ư")),
        Message::ButtonPressed45 => pushfn(String::from("ụ")),
        Message::ButtonPressed46 => pushfn(String::from("ữ")),
        Message::ButtonPressed47 => pushfn(String::from("ú")),
        Message::ButtonPressed48 => pushfn(String::from("ủ")),
        Message::ButtonPressed49 => pushfn(String::from("í")),
        Message::ButtonPressed50 => pushfn(String::from("ì")),
        Message::ButtonPressed51 => pushfn(String::from("ị")),
        Message::ButtonPressed52 => pushfn(String::from("ế")),
        Message::ButtonPressed53 => pushfn(String::from("ẹ")),
        Message::ButtonPressed54 => pushfn(String::from("ể")),
        Message::ButtonPressed55 => pushfn(String::from("(")),
        Message::ButtonPressed56 => pushfn(String::from(")")),
        Message::ButtonPressed57 => pushfn(String::from(";")),
        Message::ButtonPressed58 => pushfn(String::from(":")),
  ...
  fn view(&mut self) -> Element<Message> {
    ...
    let buttons2 = [
        ...
        add_button(&mut self.button_state44, shiftfn(String::from("ư")), Message::ButtonPressed44),
        add_button(&mut self.button_state45, shiftfn(String::from("ụ")), Message::ButtonPressed45),
        add_button(&mut self.button_state46, shiftfn(String::from("ữ")), Message::ButtonPressed46),
        add_button(&mut self.button_state47, shiftfn(String::from("ú")), Message::ButtonPressed47),
        add_button(&mut self.button_state48, shiftfn(String::from("ủ")), Message::ButtonPressed48),
        add_button(&mut self.button_state49, shiftfn(String::from("í")), Message::ButtonPressed49),
        add_button(&mut self.button_state50, shiftfn(String::from("ì")), Message::ButtonPressed50),
        add_button(&mut self.button_state51, shiftfn(String::from("ị")), Message::ButtonPressed51),
        add_button(&mut self.button_state52, shiftfn(String::from("ế")), Message::ButtonPressed52),
        add_button(&mut self.button_state53, shiftfn(String::from("ẹ")), Message::ButtonPressed53),
        add_button(&mut self.button_state54, shiftfn(String::from("ể")), Message::ButtonPressed54),
    ];
    let buttons3 = [
        add_button(&mut self.button_state55, shiftfn(String::from("(")), Message::ButtonPressed55),
        add_button(&mut self.button_state56, shiftfn(String::from(")")), Message::ButtonPressed56),
        add_button(&mut self.button_state57, shiftfn(String::from(";")), Message::ButtonPressed57),
        add_button(&mut self.button_state58, shiftfn(String::from(":")), Message::ButtonPressed58),
